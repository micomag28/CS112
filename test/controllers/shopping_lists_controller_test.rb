...
class ShoppingListsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post :create, shopping_list: { deadline: @shopping_list.deadline, name: @shopping_list.name, total_price: @shopping_list.total_price }
    end
  ...
  test "should update shopping_list" do
    patch :update, id: @shopping_list, shopping_list: { deadline: @shopping_list.deadline, name: @shopping_list.name, total_price: @shopping_list.total_price }
    assert_redirected_to shopping_list_path(assigns(:shopping_list))
  end
